...
GLOBAL_CONFIG_SCHEMA_PATH = os.path.join(SCHEMAS_ROOT,
                                         'global_config_schema.yml')
GLOBAL_STATUS_SCHEMA_PATH = os.path.join(SCHEMAS_ROOT,
                                         'global_status_schema.yml')
SERVICE_CONFIG_SCHEMA_PATH = os.path.join(SCHEMAS_ROOT,
                                          'service_config_schema.yml')
SERVICE_STATUS_SCHEMA_PATH = os.path.join(SCHEMAS_ROOT,
                                          'service_status_schema.yml')
...
def _validate_with_schema(obj, schema_file):
    ...
    print(schema_file, str(['validating', str(obj), str(schema)]))
